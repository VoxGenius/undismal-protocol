...
Note: While our primary analysis uses monthly data, the structural break tests in Table \ref{tab:structural_breaks} are reported at quarterly frequency following standard practice in the break-testing literature. This aggregation provides more stable test statistics and aligns with the quarterly decision-making cycle of monetary policy. The monthly data are averaged within quarters for these tests only.
